...
void pfilter_init_default()
{
    ...
    //For the Sync FollowUp P2P PTP
    //pfilter_cmp(0, 0x0180, 0xffff, MOV, 2); 
 	//pfilter_cmp(1, 0xc200, 0xffff, AND, 2);
 	//pfilter_cmp(2, 0x000e, 0xffff, AND, 2); // r4 = 1 when dst mac is PTP P2P multicast (01:80:C2:00:00:0E)
